    ...
    <div className="h-screen h-[100dvh] flex flex-col overflow-hidden"
      ...
      <style>{`
        ...
        :root {
          ...
          --board-padding: 6px;
          --deck-width: calc(var(--board-width) * 0.165);
          --deck-height: calc(var(--board-width) * 0.21);
          --deck-bottom-offset: calc(var(--board-width) * 0.04);
          --deck-stack-height: calc(var(--board-width) * 0.14);
          --deck-top-card-height: calc(var(--board-width) * 0.145);
          --deck-icon-size: calc(var(--board-width) * 0.045);
          --deck-label-size: calc(var(--board-width) * 0.015);
          --deck-bottom-label-size: calc(var(--board-width) * 0.0125);
          --deck-gap: calc(var(--board-width) * 0.0075);
          --deck-top: 12%;
          --deck-right: 12%;
          --deck-bottom: 12%;
          --deck-left: 12%;
        ...
        @media (max-width: 768px) {
          :root {
            ...
            --board-padding: 2px;
            --deck-width: calc(var(--board-width) * 0.13);
            --deck-height: calc(var(--board-width) * 0.175);
            --deck-bottom-offset: calc(var(--board-width) * 0.02);
            --deck-stack-height: calc(var(--board-width) * 0.11);
            --deck-top-card-height: calc(var(--board-width) * 0.115);
            --deck-icon-size: calc(var(--board-width) * 0.035);
            --deck-label-size: calc(var(--board-width) * 0.015);
            --deck-bottom-label-size: calc(var(--board-width) * 0.012);
            --deck-gap: calc(var(--board-width) * 0.004);
            --deck-top: 10%;
            --deck-right: 10%;
            --deck-bottom: 10%;
            --deck-left: 10%;
